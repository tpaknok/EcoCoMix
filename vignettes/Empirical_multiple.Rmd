...
```{r ggplot2,fig.width=8,fig.height=8}
...
library(DHARMa)
sres <- INLA_simulate(BEF_KSR[[10]]$best_model)
DHARMa_res <- createDHARMa(sres,
                           KSR_EF_list[[10]][,y[[10]]],
                           BEF_KSR[[10]]$predicttedfittedresponse)
