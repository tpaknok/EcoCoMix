...
![Histograms of LAI](figure/LAI-1.png)
...
![Histograms of floral abundance](figure/flwr total-1.png)
...
#> 
#>  *** inla.core.safe:  The inla program failed, but will rerun in case better initial values may help. try=1/1
#> Error in inla.core.safe(formula = formula, family = family, contrasts = contrasts, : The inla program call crashed.
...
#> Error in FUN(X[[i]], ...): object 'BEF_KSR' not found
```
...
#> Error in eval(expr, envir, enclos): object 'all_predictions' not found
```
...
plot(p)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'p' not found
```
