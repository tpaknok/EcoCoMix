...
#>    .parent.frame)" ) 
#> Time used:
#>     Pre = 0.335, Running = 0.266, Post = 0.175, Total = 0.777 
#> Fixed effects:
#>              mean    sd 0.025quant 0.5quant 0.975quant  mode kld
#> (Intercept) 2.155 0.314       1.51    2.164      2.748 2.163   0
#> Real.rich   0.080 0.096      -0.11    0.080      0.270 0.080   0
#> 
#> Random effects:
#>   Name	  Model
#>     comm Generic0 model
...
#> size for the nbinomial observations (1/overdispersion) 2.54 0.514      1.677     2.49       3.69 2.39
#> Precision for comm                                     2.81 1.485      0.939     2.49       6.61 1.94
#> 
#> Watanabe-Akaike information criterion (WAIC) ...: 617.42
#> Effective number of parameters .................: 11.92
#> 
#> Marginal log-Likelihood:  -868.30 
#>  is computed 
...
#>    .parent.frame)" ) 
#> Time used:
#>     Pre = 0.198, Running = 0.199, Post = 0.0523, Total = 0.449 
#> Fixed effects:
#>              mean    sd 0.025quant 0.5quant 0.975quant  mode kld
#> (Intercept) 2.043 0.242      1.555    2.047      2.508 2.047   0
#> Real.rich   0.024 0.063     -0.102    0.025      0.147 0.025   0
#> 
#> Random effects:
#>   Name	  Model
#>     comm Generic0 model
...
#> Model hyperparameters:
#>                    mean    sd 0.025quant 0.5quant 0.975quant mode
#> Precision for comm 1.78 0.678       0.73     1.68       3.36 1.50
#> 
#> Watanabe-Akaike information criterion (WAIC) ...: 872.72
#> Effective number of parameters .................: 69.21
#> 
#> Marginal log-Likelihood:  -973.65 
#>  is computed 
#> Posterior summaries for the linear predictor and the fitted values are computed
#> (Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
