...
#>    .parent.frame)" ) 
#> Time used:
#>     Pre = 0.276, Running = 0.306, Post = 0.202, Total = 0.784 
#> Fixed effects:
#>              mean    sd 0.025quant 0.5quant 0.975quant  mode kld
#> (Intercept) 2.223 0.221      1.780    2.225      2.650 2.225   0
#> Real.rich   0.091 0.092     -0.088    0.090      0.273 0.090   0
#> 
#> Random effects:
#>   Name	  Model
#>     comm Generic0 model
...
#> size for the nbinomial observations (1/overdispersion) 2.51 0.504       1.66     2.46       3.64 2.36
#> Precision for comm                                     4.20 2.144       1.46     3.74       9.65 2.96
#> 
#> Watanabe-Akaike information criterion (WAIC) ...: 618.55
#> Effective number of parameters .................: 12.05
#> 
#> Marginal log-Likelihood:  -884.01 
#>  is computed 
...
#>    .parent.frame)" ) 
#> Time used:
#>     Pre = 0.262, Running = 0.215, Post = 0.0831, Total = 0.56 
#> Fixed effects:
#>              mean    sd 0.025quant 0.5quant 0.975quant  mode kld
#> (Intercept) 2.024 0.247      1.528    2.027      2.501 2.027   0
...
#> Model hyperparameters:
#>                    mean    sd 0.025quant 0.5quant 0.975quant mode
#> Precision for comm 1.64 0.624      0.673     1.55       3.09 1.38
#> 
#> Watanabe-Akaike information criterion (WAIC) ...: 872.66
#> Effective number of parameters .................: 69.32
#> 
#> Marginal log-Likelihood:  -972.61 
#>  is computed 
#> Posterior summaries for the linear predictor and the fitted values are computed
#> (Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
...
![Predicted effects of species richness on arthropod abundance](figure/bugs-1.png)
