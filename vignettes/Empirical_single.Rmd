...
```{r mixed model lambda 1, message=F, warning=F
m_LAI$original_VCV_model
m_LAI$original_VCV_m_satt
get_R2(m_LAI$original_VCV_model)
}
```
Details about all results provided by EcoCoMix are provided [here](https://tpaknok.github.io/EcoCoMix/reference/EcoCoMix.html).
